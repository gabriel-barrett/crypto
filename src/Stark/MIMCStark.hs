...
module Stark.MIMCStark where

import Data.Array
import qualified Data.ByteString as B
import Data.Either
import Data.List
import Field.Fq as Fq
...
import Merkle.FRI as FRI
import Merkle.MerkleTree as MerkleTree
import Stark.FqConfig as FqConfig
  ...
  where
    ...
    cOfPEvaluations =
      zipWith3
        ...
        pEvaluations
        (cycleL extensionFactor pEvaluations)
        (cycle constantsMiniExtension)
    ...
    mtree =
      merkelizeA
        [ Left $ B.concat $ map intToBytes32 [pval, dval, bval]
