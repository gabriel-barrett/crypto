...
directProof =
  [ "c1fbbd6777b922ecc83a9bc2ba541e158eca8ceead4961ae899ea82fa02be",
...
prop_wrongFri1 =
  not $
    verifyLowDegreeProof
      (merkelize fakedata !! 1)
      rootOfUnity
      proof
      (fromInteger nPolyCoeffs)
      fieldModulus
      0
...
prop_wrongFri2 =
  not $
    verifyLowDegreeProof
      (merkelize evaluations !! 1)
      rootOfUnity
      proof
      (fromInteger nPolyCoeffs `div` 2)
      fieldModulus
      0
